...
if (isset($_POST['id']) && isset($_POST['order_format']) )
    {
    $id=$_POST['id'];
	$order_format=$_POST['order_format'];
    //get current date
    $today= date("d-m-Y H:i");
    // mysql updating a new row
    $sql_command="UPDATE sellers_accounts SET orderformat='$order_format', datechanged='$today' WHERE id=$id";
